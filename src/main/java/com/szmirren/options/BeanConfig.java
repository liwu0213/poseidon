...
public class BeanConfig {
	/** 生成模板的名字 */
	private String templateName = Constant.TEMPLATE_NAME_BEAN;
	/** 字段使用驼峰命名 */
	 ...
	 * @param obj
	 */
	public BeanConfig(JSONObject obj) {
		super();
	...
	public ObservableList<TableAttributeBean> getTblPropertyValues() {
		return tblPropertyValues;
	}
	public void setTblPropertyValues(ObservableList<TableAttributeBean> tblPropertyValues) {
	...
	public String toString() {
		return "BeanConfig [templateName=" + templateName + ", fieldCamel=" + fieldCamel + ", overrideFile=" + overrideFile
