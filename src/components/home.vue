<template>
  <div id="home">
    ...
    <h1
      style="background-image: url('../../static/timg2.jpg' );height: 500px;padding-top: 300px;color: white; margin: 0px">
      版主信息<br>扣扣：1977339740<br>加好友送个锤子</h1>
    <h1
      style="background-image: url('../../static/test5.jpg' ) ;height: 400px;color: white; margin: 0px;padding-top: 200px">
    ...
    <!--<img src="../../static/test1.png"/>-->
  </div>
</template>

<script>/* eslint-disable indent */

import MySnake from './mySnake'
